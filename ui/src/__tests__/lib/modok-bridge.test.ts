...
const validPacketJson = JSON.stringify({ issue: { summary: 'y', anchors: { features: [], errors: [], symptoms: [] } }, affected_areas: [], relevant_files: [], relevant_tests: [], known_issues: [], prior_fixes: [], summary: 'y' })
