...
const validPacketJson = JSON.stringify({ issue: { id: 'x', summary: 'y' }, anchors: { feature_slugs: [], error_signatures: [], symptoms: [] }, relevant_docs: [], relevant_files: [], relevant_tests: [], known_issues: [], prior_fixes: [] })
