...
- [ ] **DEPG-USAGE-001** [U]: The system shall run file-to-dependency-usage mapping once per `ingest-docs` invocation, after the existing per-doc write loop in `run_ingestion` completes.
